...
-- =====================================================================
-- Script Purpose:
--     Creates tables in the 'bronze' schema, dropping them first if they exist.
--     Use this script to re-define the DDL structure of 'bronze' tables.
-- =====================================================================
...
-- Drop and create bronze.bronze_load_log (Log table)
